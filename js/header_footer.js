class SpecialHeader extends HTMLElement{
    ...
    <header>
        <nav class="navbar">
            <!-- logo -->
            <div class="navbar__logo" onclick="viewHome()">
                <a id="logo__icon" href="index.html"><img src="../img/OnlyManga.jpg" alt="website logo"></a>
            </div>
            <!-- links -->
            ...
            <div class="navbar__home" id="navbar__home" style="display: flex">
                ...
                <div style="display: flex">
                    <a href="#" id="login__icon" onclick="viewUserInfo()">
