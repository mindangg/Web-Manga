var bestSellingProduct = [
...

    {
        ...
        author: "Yuki Tabata", 
        category: "Shounen", 
        cover1: "../img/books/my hero academia/my-hero-academia-manga-volume-11-primary.jpg", 
        cover2: "../img/books/my hero academia/my-hero-academia-manga-volume-11-back.jpg", 
        name: " Kohei Korikoshi - Volume 11", 
        price: 7.99, 
        stock: 150,
        description: "My Hero Academia volume 11 features story and art by Kohei Korikoshi."
...
document.getElementById("product__view2").addEventListener("click", function(){
    document.getElementById("product__cover1").style.opacity = 0;
})

document.getElementById("product__view1").addEventListener("click", function(){
    document.getElementById("product__cover1").style.opacity = 1;
})
    ...
    productInfo.innerHTML = `
                <div class="product">
                    ...
                    <div class="product__img">
                        ...
                        <a id="product__view1"><img src="${p.cover1}"></a>

                        <a id="product__view2"><img src="${p.cover2}"></a>
...
var bookProduct = [
...

    {
        ...
        author: "Gege Akutami", 
        category: "Action", 
        cover1: "../img/books/jujutsu kaisen/jujutsu-kaisen-manga-volume-22-primary.jpg", 
...
var productArray = [
    {
        ...
        category: "Comedy", 
        cover1: "../img/books/spy x family/spy-x-family-volume-3-primary.jpg", 
        cover2: "../img/books/spy x family/spy-x-family-volume-3-primary.jpg", 
        name: "Spy X Family - Volume 03", 
        price: 7.99, 
        stock: 100,
        description: "Spy x Family manga volume 3 features story and art by Tatsuya Endo."
...

    {
        ...
        category: "Action", 
        cover1: "../img/books/jujutsu kaisen/jujutsu-kaisen-volume-4-primary.jpg", 
        cover2: "../img/books/jujutsu kaisen/jujutsu-kaisen-volume-4-primary.jpg", 
        name: "Jujutsu Kaisen - Volume 04", 
        price: 7.99, 
        stock: 90,
    ...
    },
    {
        ...
        cover2: "../img/books/jujutsu kaisen/jujutsu-kaisen-volume-14-primary.jpg", 
    ...
    },
    {
        ...
        price: 7.99, 
        stock: 90,
        description: "Jujutsu Kaisen manga volume 04 features story and art by Gege Akutami."
        + " While investigating a strange set of mysterious deaths, Itadori meets Junpei, a troubled kid who is often bullied at school, and they immediately hit it off. However, Junpei is also befriended by the culprit behind the bloody incidents—Mahito, a mischievous cursed spirit! Mahito sets in motion a devious plan involving Junpei, hoping to ensnare Itadori as well.",
    },
