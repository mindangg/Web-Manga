...
productInfo.innerHTML = `
    <div class="product">
        ...
        <div class="product__img">
            ...
            <a id="product__view1"><img src="../img/books/sakamoto days/sakamoto-days-volume-6-primary.jpg"></a>

            <a id="product__view2"><img src="../img/books/sakamoto days/sakamoto-days-volume-6-back.jpg"></a>
        ...
        <div class="product__info">
            ...
            <p>Dangerous serial killers clash with the Order and Sakamoto’s crew! As the battles rage on, Sakamoto undergoes an unexpected transformation. Meanwhile, the evil mastermind X reveals his true intent, which sends shock waves through the assassin world!</p>
        </div>
        </div>
    </div>
`
